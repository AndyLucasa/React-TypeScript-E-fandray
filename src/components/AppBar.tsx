...
export class AppBar extends Component {
    ...
    render() {
        return (
            <div className="AppBar h-full bg-gray-900 md:bg-gray-800  grid grid-cols-12 items-center sticky top-0 z-10 md:border-b border-gray-700 shadow-lg text-gray-200">
